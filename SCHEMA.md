...
| `arrival_window_start` | `time \| null` | Start of the movers' arrival window (e.g. `08:00`); null = TBD |
| `arrival_window_end` | `time \| null` | End of the movers' arrival window (e.g. `10:00`); null = TBD |
